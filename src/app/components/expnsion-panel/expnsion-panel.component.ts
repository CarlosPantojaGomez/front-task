...
export class ExpnsionPanelComponent implements OnInit, OnChanges , OnDestroy {
  ...
  public showCreation: Array<boolean> = [];
  ...
  private setChild(n: number, start: number, end: number): void {
  ...
  public refreshList(product: Product): void {
    ...
    this.homeService.products.push(product);
